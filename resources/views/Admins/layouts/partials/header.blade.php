        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="index.html" class="logo">
                <span class="logo-light">
                    <span class="logo-lg"><img src="{{ asset('assets/admin/assets/images/logo.png') }}"
                            alt="logo"></span>
            ...
            <div class="topbar-item">
                <div class="dropdown">
                    <button class="topbar-link" data-bs-toggle="dropdown" data-bs-offset="0,25" type="button"
                        ...
                        <img src="{{asset('assets/admin/assets/images/flags/us.svg')}}" alt="user-image" class="w-100 rounded" height="18"
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="en">
                            <img src="{{asset('assets/admin/assets/images/flags/us.svg')}}" alt="user-image" class="me-1 rounded"
                                height="18" data-translator-image> <span class="align-middle">English</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="hi">
                            <img src="{{asset('assets/admin/assets/images/flags/in.svg')}}" alt="user-image" class="me-1 rounded"
                                height="18" data-translator-image> <span class="align-middle">Hindi</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{asset('assets/admin/assets/images/flags/de.svg')}}" alt="user-image" class="me-1 rounded"
                                height="18"> <span class="align-middle">German</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{asset('assets/admin/assets/images/flags/it.svg')}}" alt="user-image" class="me-1 rounded"
                                height="18"> <span class="align-middle">Italian</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{asset('assets/admin/assets/images/flags/es.svg')}}" alt="user-image" class="me-1 rounded"
                                height="18"> <span class="align-middle">Spanish</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{asset('assets/admin/assets/images/flags/ru.svg')}}" alt="user-image" class="me-1 rounded"
                    ...
                    <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
                        ...
                        <div class="position-relative z-2 card shadow-none rounded-0" style="max-height: 300px;"
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap active" id="notification-1">
                                <span class="d-flex align-items-center">
                                    <span class="me-3 position-relative flex-shrink-0">
                                        <img src="{{asset('assets/admin/assets/images/users/avatar-2.jpg')}}" class="avatar-md rounded-circle"
                                            alt="" />
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-2">
                                <span class="d-flex align-items-center">
                                    <span class="me-3 position-relative flex-shrink-0">
                                        <img src="{{asset('assets/admin/assets/images/users/avatar-4.jpg')}}" class="avatar-md rounded-circle"
                                            alt="" />
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-4">
                                <span class="d-flex align-items-center">
                                    <span class="me-3 position-relative flex-shrink-0">
                                        <img src="{{asset('assets/admin/assets/images/users/avatar-7.jpg')}}" class="avatar-md rounded-circle"
                                            alt="" />
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-5">
                                <span class="d-flex align-items-center">
                                    <span class="me-3 position-relative flex-shrink-0">
                                        <img src="{{asset('assets/admin/assets/images/users/avatar-10.jpg')}}" class="avatar-md rounded-circle"
                                            alt="" />
                                        <span class="position-absolute rounded-pill bg-danger notification-badge">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg p-0">
                        <div class="p-2">
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{asset('assets/admin/assets/images/brands/slack.svg')}}" alt="slack">
                                        <span>Slack</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{asset('assets/admin/assets/images/brands/gitlab.svg')}}" alt="Github">
                                        <span>Gitlab</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{asset('assets/admin/assets/images/brands/dribbble.svg')}}" alt="dribbble">
                                        <span>Dribbble</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{asset('assets/admin/assets/images/brands/bitbucket.svg')}}" alt="bitbucket">
                                        <span>Bitbucket</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{asset('assets/admin/assets/images/brands/dropbox.svg')}}" alt="dropbox">
                                        <span>Dropbox</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{asset('assets/admin/assets/images/brands/google-cloud.svg')}}" alt="G Suite">
                                        <span>G Cloud</span>
                                    </a>
                                </div>
                            </div> <!-- end row-->
                            ...
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{asset('assets/admin/assets/images/brands/aws.svg')}}" alt="bitbucket">
                                        <span>AWS</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{asset('assets/admin/assets/images/brands/digital-ocean.svg')}}" alt="dropbox">
                                        <span>Server</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{asset('assets/admin/assets/images/brands/bootstrap.svg')}}" alt="G Suite">
                                        <span>Bootstrap</span>
                                    </a>
                                </div>
                            </div> <!-- end row-->
            ...
            <div class="topbar-item nav-user">
                <div class="dropdown">
                    <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown"
                        ...
                        <img src="{{asset('assets/admin/assets/images/users/avatar-1.jpg')}}" width="32"
